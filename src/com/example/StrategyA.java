...
public class StrategyA implements PlayerStrategy {
     ...
     */
    private static ArrayList<Meld> formBestMeldSet(Set<Card> cards){
        ArrayList<Meld> allMelds = getAllMelds(cards);

        ArrayList<ArrayList<Meld>> allValidMeldSets = nani(allMelds, new ArrayList<>());
        ArrayList<Meld> bestMeldSet = pickBestMeldSet(allValidMeldSets);
    }

    private static ArrayList<ArrayList<Meld>> nani(ArrayList<Meld> melds, ArrayList<ArrayList<Meld>> allMeldSets){
